...
const CardTab = () => {
  return (
     <div className="w-screen flex flex-col items-center gap-7 sm:gap-16 sm:flex-row sm:justify-center mx-auto shadow-2xl pb-24">
      <Card className=" bg-stone-50 w-96 sm:w-sm  rounded-lg">
