...
const Content = () => {
  return (
       <div className='flex justify-center items-center bg-sky-50 mt-5 flex-col'> 
          <div className='flex flex-col justify-center gap-4 mt-20 sm:mt-14'>
            ...
            <div className='mt-5 flex justify-between gap-5 '>
               ...
               <Link href={'/Signin'}>
                   <div className='bg-white hover:bg-blue-100  sm:w-56 sm:h-14 sm:text-2xl  flex text-shadow-black font-se w-32 justify-center h-10 items-center text-xl rounded-md '> Sign In</div>
               </Link>
            </div>
            <div>
              <CardDetails/>
